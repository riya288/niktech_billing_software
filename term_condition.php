...
if(isset($_GET['dId'])){
    $id = $_GET['dId'];
    $query = "DELETE FROM term_condition WHERE id = '$id'";
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Term Condition Detail
                                    </h4>
                        ...
                        <div class="row card-box">
                            <div class="col-md-12">
                                <div  id="Show_target_div">
                                    <form name="form" action="action/term_condition.php/" id="form" method="post"    enctype="multipart/form-data">
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                             <div class="col-md-10">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="name">Add Term Condition:</label>
                                                                    <textarea name="name" id="name" class="summernote" value="<?php if(isset($name) && !empty($name)) {echo $name;} ?>"><?php if(isset($name) && !empty($name)) {echo $name;} ?></textarea>
                      ...
                      <?php require_once('view_term_condition.php');?>
            <!-- ============================================================== -->
            <!-- End of the page -->
            <!-- ============================================================== -->
                </div> <!-- container -->
